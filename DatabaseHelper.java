...
public class DatabaseHelper
    ...
    private static String DB_NAME = "dataGeeks.db";
    ...
    public static final String
            ALGO_TOPICS
            = "tbl_geeksCourses";
    public static final String laTabla = "tbl_schooCourses";
    /**
     * Constructor
...

    {
        ...
        db.execSQL("DROP TABLE IF EXISTS tbl_geekCourses");
        db.execSQL("DROP TABLE IF EXISTS tbl_schooCourses");
        onCreate(db);
    }
    ...
    public List<String> getListOfTable(Activity activity)
    {
        ...
        Cursor cursor2 = db.rawQuery("SELECT COUNT(*) FROM tbl_schooCourses;", null);
        ...
        String query = "SELECT name FROM " + ALGO_TOPICS + " EXCEPT SELECT courses FROM tbl_schooCourses;";
        //String query = "SELECT name FROM " + ALGO_TOPICS;
        //String query = "SELECT * FROM tbl_geeksCourses;";
        //String query = "SELECT * FROM " + ALGO_TOPICS;
        //String query = "SELECT * FROM tbl_schooCourses;";
